...
public class Ex1 {
    ...
    public static int number2Int(String num) {
        ...
        // number part into a decimal integer value
        int result = 0;
        for (int i = 0; i < numberPart.length(); i++) {
            ...
            if (digitChar >= '0' && digitChar <= '9') {
                ...
                return -1; // Invalid character in number part
            }
    ...
    public static String int2Number(int num, int base) {
        ...
        return Integer.toString(num, base); // Usage of the Java Builtin convertor
    }

    // Find  maximum value number from the number Array
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            boolean numberChecker; // check if the input number is valid as a boolean

            // Check if first input number is valid
            if (number2Int(num1) == -1) {
                numberChecker = false; // Invalid number
            } else {
                numberChecker = true; // Valid number
            }
